...
@section('sub-title', 'اضافة مدير برنامج')
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title float-left">اضافة البيانات </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form>
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-footer">
                                    <button type="button" onclick="performStore()" class="btn btn-primary">انشاء</button>
