...
@section('sub-title', 'تعديل بيانات مدير البرنامج')
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title float-left">تعديل بيانات مدير البرنامج</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="first_name" name="first_name"
                                            value="{{ $authors->first_name }}" placeholder="أدخل الاسم الأول">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="last_name">الأسم الاخير</label>
                                        <input type="text" class="form-control" id="last_name" name="last_name"
                                            value="{{ $authors->last_name }}" placeholder="أدخل الاسم الأخير">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="mobile" name="mobile"
                                            value="{{ $authors->mobile }}" placeholder="أدخل رقم الهاتف">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <select class="form-select form-select-sm" name="gender" style="width: 100%;"
                                            ...
                                            <option selected> {{ $authors->gender }} </option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" class="form-control" id="date" name="date"
                                            value="{{ $authors->date }}" placeholder="أدخل تاريخ الميلاد">
                                    </div>
                                </div>
