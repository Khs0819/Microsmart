                ...
                <div class="col-12">
                    ...
                    <div class="card-body table-responsive p-0">
                                            ...
                                            @if ($course->id == $CourseUser->course_id)
                                                ...
                                                <td>
                                                    <textarea class="form-control" style="resize: none;" id="description" name="description" rows="4"
                                                        placeholder="لا يوجد ملاحظات" cols="50" readonly>{{ $CourseUser->notice }}</textarea>
                                                </td>

                                                <td>
                                                    <div class="btn group">
                                                        <a href="{{ route('coursesUsers.edit', $CourseUser->id) }}"
                        ...
                        <div class="card-footer">
                            <a href="{{ route('users.index') }}" type="button" class="btn btn-secondary">الرجوع لقائمة
                                الطلاب</a>
                        </div>
