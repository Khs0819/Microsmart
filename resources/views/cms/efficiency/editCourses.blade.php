                    ...
                    <div class="card card-primary">
                        ...
                        <form>
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-7">
                                        ...
                                        <textarea class="form-control" style="resize: none;" id="notice" name="notice" rows="4"
                                            placeholder=" الملاحظات او التوضيحات ان وجدت" cols="50">{{ $CourseUsers->notice }}</textarea>
                                    </div>
                                </div>
                            ...
                            <div class="card-footer">
                                ...
                                <a href="{{ route('efficiencyCourses', ['id' => $CourseUsers->user_id]) }}" type="button"
...
@section('scripts')
    <script>
        function performUpdate(id) {
            ...
            storeRoute('/dashboard/update-efficiency-coursesUsers/' + id, formData);
        }
    </script>
@endsection
