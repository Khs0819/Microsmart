                ...
                <div class="col-lg-10 col-md-8">
                    <div class="card card-default mb-0">
                        <div class="card-header pb-0">
                            <div class="app-brand w-100 d-flex justify-content-center border-bottom-0 bg ">
                                <div class="bg-dark mb-5">
                                    <a class="w-auto pl-0" href="{{ route('website.homeArabic') }}">
                                        <img src="{{ asset('website/images/mm.svg') }}" alt="hams"
                        ...
                        <div class="card-body px-5 pb-5 pt-0">
                            ...
                            <h4 class="text-dark mb-6 text-center"><b>لوحة تحكم مايكروسمارت</b></h4>
                                    ...
                                    <div class="container-login100-form-btn w-100 mt-3">
                                        <div class="wrap-login100-form-btn w-75 mx-auto">
                                            ...
                                            <a class=" btn login100-form-btn" href="{{ url('cms/author/login') }}"
                                                style="background-color: rgb(67, 67, 235); color: white;">
                                                <i class="fa-solid fa-chalkboard-user m-2"></i> تسجيل دخول كمسؤول برنامج
                                            </a>
                                        </div>
                                    </div>
                                </div>
