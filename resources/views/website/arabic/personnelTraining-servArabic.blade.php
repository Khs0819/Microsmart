...
<nav id="nav" class="navbar navbar-expand-lg d-flex justify-content-center">
    ...
    <div class="collapse navbar-collapse " id="main-nav">
        ...
        <div class="banner-personnelTraining-servArabic">
            <div class="container d-flex align-items-center ">
                <p>نحن الصلة بين الموهبة و الابداع</p>
            </div>
        </div>

        <section class="serv-personnelTraining-servArabic">
            <h3 class="text-center ss">تدريب أفراد</h3>
            <div class="container">
                <div class="row d-flex align-items-center">
                    <div class="col-12 col-lg-7">
                        <div class="text-personnelTraining-servArabic">
                         <h3> لماذا يجب أن ألتحق بالتدريب الذى تقدمه ميكروسمارت؟</h3>
                         <p>تقدم ميكروسمارت تدريب قائم على مبدأ فردانية احتياجات التدريب، ومنهجية التدريب المبني على الكفاءة الشخصية والمهنية، كما تعمل على تحليل احتياجات التدريب وتطوير مؤشرات قابلة للقياس لعملية التدريب.</p>
                         <a class="servA" href="{{ route('website.individualsArabic') }}">المزيد</a>

                        </div>
                    </div>
                    <div class="col-12  col-lg-5">
                        <div class="img-personnelTraining-servArabic">
