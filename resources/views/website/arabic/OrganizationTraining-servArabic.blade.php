...
<nav id="nav" class="navbar navbar-expand-lg d-flex justify-content-center">
    ...
    <div class="collapse navbar-collapse " id="main-nav">
        ...
        <div class="banner-OrganizationTraining-servArabic">
            <div class="container d-flex align-items-center ">
                <p>نحن الصلة بين الموهبة و الابداع</p>
            </div>
        </div>

        <section class="serv-OrganizationTraining-servArabic">
            <h3 class="text-center ff">تدريب منظمات </h3>
            <div class="container">
                <div class="row d-flex align-items-center">
                    <div class="col-12 col-lg-7">
                        <div class="text-OrganizationTraining-servArabic">
                         <h3>لماذا يجب على منظمات الأعمال الاستثمار بالموظفين؟</h3>
                         <p>إن المحرك الرئيسي للمنظمة نحو تحقيق أهدافها يتمثل فى الكفاءة التى يمتلكها الموظفين، يجب على منظمات الأعمال أن تولي رعاية مستمرة لأصولها البشرية تؤدي إلى تطوير الكفاءة، والتمييز بين القدرة على أداء المهام والرغبة فى بذل الجهد والطاقة الكامنة فى تحقيق الأهداف. إن المعيار الأهم للمنظمة لتحظي بالنجاح وتحقق أهدافها وتصبح منظمة تتمتع بأداء كفوء وفعال يقع علي عاتق مواردها البشرية. </p>
                         <a class="servA" href="{{ route('website.organizationsArabic') }}">المزيد</a>

                        </div>
                    </div>
                    <div class="col-12  col-lg-5">
                        <div class="img-OrganizationTraining-servArabic">
