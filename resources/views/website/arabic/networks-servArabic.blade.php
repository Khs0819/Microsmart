...
<nav id="nav" class="navbar navbar-expand-lg d-flex justify-content-center">
    ...
    <div class="collapse navbar-collapse " id="main-nav">
        ...
        <div class="banner-networks-servArabic">
            <div class="container d-flex align-items-center ">
                <p>نحن الصلة بين الموهبة و الابداع</p>
            </div>
        </div>

        <section class="serv-networks-servArabic">
            <h3 class="text-center ss">الشبكات</h3>
            <div class="container">
                <div class="row d-flex align-items-center">
                    <div class="col-12 col-lg-7">
                        <div class="text-networks-servArabic">
                         <h3>هل يرهقك التفكير فى جودة وتكاليف ودقة العمل؟</h3>
                         <p>نتمسك بعايير الميزة التنافسية التى تمنحنا الجهوزية للانطلاق لجعل كل التفاصيل العملياتية من وقت وتكلفة ومواصفات جودة متاحة لك.</p>
                         <a class="servA" href="{{ route('website.networksArabic') }}">المزيد</a>

                        </div>
                    </div>
                    <div class="col-12  col-lg-5">
                        <div class="img-networks-servArabic">
