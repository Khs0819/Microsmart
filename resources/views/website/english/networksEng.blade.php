            ...
            <li class="nav-item dropdown">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a class="dropdown-item text-start active" href="{{ route('website.networks') }}">Networks</a></li>
                    </ul>
                </li>
                <li class="nav-item">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12 col-lg-7">
                        <div class="text-net">
                            <h3>Networks</h3>
                            <p>Network construction tasks, designing, building, and using the network, in addition to managing, maintaining, and operating the network infrastructure, software, policies, and stringent security requirements such as end-to-end encryption, require specialized technicians to supervise the network and perform those tasks.
                                We a corporate specialize in providing computer and communication networks to customers, whether they are individuals or organizations.
                                </p>
                            <p>We work to provide reliable and specialized solutions to ensure that your ready-made or new network operates securely and efficiently.
                                In addition, we provide maintenance services so that our customers can rely on us to fix any network issues that arise at any time.
                                All the time, we work to provide high-quality services at competitive prices, always striving to improve our customers' experience.
                                </p>
