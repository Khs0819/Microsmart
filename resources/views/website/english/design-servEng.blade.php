...
<nav id="nav" class="navbar navbar-expand-lg d-flex justify-content-center">
    ...
    <div class="collapse navbar-collapse " id="main-nav">
        ...
        <section class="serv-digitalTransformation-servArabic">
            <h3 class="text-center ss">Designing </h3>
            <div class="container">
                <div class="row d-flex align-items-center">
                    <div class="col-12 col-lg-7">
                        <div class="text-digitalTransformation-servArabic">
                            <h3>Do you need someone to give you innovative solutions?</h3>
                            <p>Design requires talent and experience in order to understand customer needs, the ability to spark ideas, and focus on the smallest details that meet customer expectations. MicroSmart employees give customers the edge to brainstorm, think innovatively, and bring ideas to life. </p>
                            <a class="servA" href="{{ route('website.graphicDesign') }}">More</a>
                        </div>
                    </div>
