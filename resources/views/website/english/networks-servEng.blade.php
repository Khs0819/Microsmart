...
<nav id="nav" class="navbar navbar-expand-lg d-flex justify-content-center">
    ...
    <div class="collapse navbar-collapse " id="main-nav">
        ...
        <section class="serv-digitalTransformation-servArabic">
            <h3 class="text-center ss">Networks </h3>
            <div class="container">
                <div class="row d-flex align-items-center">
                    <div class="col-12 col-lg-7">
                        <div class="text-digitalTransformation-servArabic">
                            <h3>Does thinking about the quality, cost, and accuracy of work exhaust you?</h3>
                            <p>We adhere to the standards of competitive advantage that give us the readiness to launch to make all operational details of time, cost, and quality specifications available to you. </p>
                            <a class="servA" href="{{ route('website.networks') }}">More</a>
                        </div>
                    </div>
