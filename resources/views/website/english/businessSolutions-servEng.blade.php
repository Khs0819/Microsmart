...
@section('content')
    ...
    <nav id="nav" class="navbar navbar-expand-lg d-flex justify-content-center">
        ...
        <section class="serv-digitalTransformation-servArabic">
            <h3 class="text-center ss">Business solutions</h3>
            <div class="container">
                <div class="row d-flex align-items-center">
                    <div class="col-12 col-lg-7">
                        <div class="text-digitalTransformation-servArabic">
                            <h3>Business solutions</h3>
                            <p>Business solutions are a combination of ideas that are reliable and ensure their ability to help the organization to achieve its goals. Solutions include assessment, planning, and synthesis of complex business information. Business solutions also address the development of strategies aimed at expanding local and international markets. </p>
                            <a class="servA" href="{{ route('website.businessSolutions') }}">More</a>
                        </div>
                    </div>
