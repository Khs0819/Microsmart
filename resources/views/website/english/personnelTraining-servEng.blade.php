...
@section('title','Individual Training Program')
...
<nav id="nav" class="navbar navbar-expand-lg d-flex justify-content-center">
    ...
    <div class="collapse navbar-collapse " id="main-nav">
        ...
        <section class="serv-digitalTransformation-servArabic">
            <h3 class="text-center ss">Individual Training Program </h3>
            <div class="container">
                <div class="row d-flex align-items-center">
                    <div class="col-12 col-lg-7">
                        <div class="text-digitalTransformation-servArabic">
                            <h3>Why should I join the training offered by MicroSmart? </h3>
                            <p>MicroSmart offers training based on the principle of individualization, and the methodology of competency-based personal and professional training. It also analyzes training needs and develops measurable indicators for the training process.</p>
                            <a class="servA" href="{{ route('website.individuals') }}">More</a>
                        </div>
                    </div>
